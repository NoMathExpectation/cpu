...
HD_PWD='D:/projects/sustech/computer_organization/labs/cpu/cpu.runs/data_memory_internal_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log data_memory_internal.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source data_memory_internal.tcl
