...
set cached_ip [config_ip_cache -export -no_bom -use_project_ipc -dir D:/projects/sustech/computer_organization/labs/cpu/cpu.runs/data_memory_internal_synth_1 -new_name data_memory_internal -ip [get_ips data_memory_internal]]

if { $cached_ip eq {} } {

synth_design -top data_memory_internal -part xc7a35tcsg324-1 -mode out_of_context
...
set_param constraints.enableBinaryConstraints false
 ...
 write_checkpoint -force -noxdef -rename_prefix data_memory_internal_ data_memory_internal.dcp

 set ipCachedFiles {}
 write_verilog -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ data_memory_internal_stub.v
 lappend ipCachedFiles data_memory_internal_stub.v

 write_vhdl -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ data_memory_internal_stub.vhdl
 lappend ipCachedFiles data_memory_internal_stub.vhdl

 write_verilog -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ data_memory_internal_sim_netlist.v
 lappend ipCachedFiles data_memory_internal_sim_netlist.v

 write_vhdl -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ data_memory_internal_sim_netlist.vhdl
 lappend ipCachedFiles data_memory_internal_sim_netlist.vhdl

 config_ip_cache -add -dcp data_memory_internal.dcp -move_files $ipCachedFiles -use_project_ipc -ip [get_ips data_memory_internal]
}

rename_ref -prefix_all data_memory_internal_

# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef data_memory_internal.dcp
